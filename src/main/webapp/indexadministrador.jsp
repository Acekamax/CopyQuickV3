    ...
    <body>
        ...
        <div class="administrador">
            ...
            <form action="/saldo" class="administrador-container" method="post">
                ...
                <input  action="" type="text" id="correo" onclick="if (this.value == 'correo')
            this.value = ''" onblur="if (this.value == '')
                        this.value = 'correo'">
                &nbsp;  
                <input action="" type="text" id="nomusuario" onclick="if (this.value == 'nombre usuario')
            this.value = ''" onblur="if (this.value == '')
                        this.value = 'nombre usuario'"> 
                &nbsp;
                <input action="" type="text" id="saldo" onclick="if (this.value == 'valor')
            this.value = ''" onblur="if (this.value == '')
                        this.value = 'valor'"> 
                &nbsp;
                <center>
                    ...
                    <a onclick="agrearSaldo()" class="button">Otorgar bono</a>
                    <a href="versaldo.jsp" class="button">Ver bonos</a>
                </center>
            </form>
            <div>
            </div>
